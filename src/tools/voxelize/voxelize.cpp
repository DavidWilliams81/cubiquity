...
int main(int /*argc*/, char** /*argv*/)
{
	...
	const char* filename = "axis.obj";
	std::cout << "Loading \"" << path << "/" << filename << "\"..." << std::endl;
	auto objects = loadObjFile(path, filename);
	...
	for(auto& object : objects)
	{
		...
		voxelize(temp, surface, true, internalMaterialOverride, externalMaterialOverride, &progressBar);
