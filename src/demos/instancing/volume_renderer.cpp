...
VolumeRenderer::VolumeRenderer()
{
	...
	{
	case GlyphType::Cube:
		program.LoadShaders("../src/demos/instancing/cube_vertex_program.glsl", "../src/demos/instancing/cube_fragment_program.glsl");
		break;
	case GlyphType::Point:
		program.LoadShaders("../src/demos/instancing/point_vertex_program.glsl", "../src/demos/instancing/point_fragment_program.glsl");
		break;
	default:
